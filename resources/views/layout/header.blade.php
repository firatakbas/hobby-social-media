            ...
            @auth
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open"
                        ...
                        <div class="py-1">
                            <a href="{{ route('profile.show', auth()->user()) }}" class="flex items-center px-3 py-1.5 hover:bg-gray-100 text-gray-700">
                                <!-- Profil -->
                            ...
                            <a href="{{ route('account.edit') }}" class="flex items-center px-3 py-1.5 hover:bg-gray-100 text-gray-700">
                                <!-- Ayarlar -->
