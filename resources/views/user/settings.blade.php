...
@section('content')
    ...
    <form action="{{ route('account.update') }}" class="space-y-4" method="post">
        @csrf
        @method('PUT')
        ...
        <section class="bg-white rounded-xl shadow-sm overflow-hidden p-6">
            ...
            <p class="bg-blue-400 p-3 rounded-lg text-white mb-3">Kullanıcı Adınızı Sosyal Medya Hesaplarına Giriniz</p>
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Instagram</label>
                    <input type="text" value="{{ auth()->user()->profile->instagram }}" class="w-full border rounded-md px-3 py-2 text-sm" name="instagram" placeholder="ORN: frat_akbas">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Facebook</label>
                    <input type="text" value="{{ auth()->user()->profile->facebook }}" class="w-full border rounded-md px-3 py-2 text-sm" name="facebook" placeholder="ORN: frat_akbas">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">X(Twitter)</label>
                    <input type="text" value="{{ auth()->user()->profile->twitter }}" class="w-full border rounded-md px-3 py-2 text-sm" name="twitter" placeholder="ORN: frat_akbas">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Snapchat</label>
                    <input type="text" value="{{ auth()->user()->profile->snapchat }}" class="w-full border rounded-md px-3 py-2 text-sm" name="snapchat" placeholder="ORN: frat_akbas">
                </div>
                <div>
